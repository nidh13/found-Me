...
class AlertDialogSuccess extends ModalRoute<void> {
  String message;
  BuildContext context;
  AlertDialogSuccess(this.message, this.context);
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      width: screenWidth * 0.85,
                      decoration: BoxDecoration(
                          color: ColorConstant.colorSuccess,
                          borderRadius:
