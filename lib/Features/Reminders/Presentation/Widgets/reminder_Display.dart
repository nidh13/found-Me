                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(
                            left: 17, right: 17, top: 14.5),
                        child: Text(
                          "reminders_label_setdatetime".tr(),
                          textScaleFactor: 1.0,
                          style: TextStyle(
                            color: ColorConstant.pinkColor,
                            fontFamily: 'SourceSansPro',
                    ...
                    Stack(
                      children: [
                        Align(
                          ...
                          child: Padding(
                            padding:
                                EdgeInsets.only(left: 17, right: 17, top: 14.5),
                            child: Text(
                    ...
                    Padding(
                      ...
                      child: MyButton(
                        ...
                        onPressed: () {
                          ...
                          profile.parameters.location = 'DeleteReminder';
                    ...
                    Padding(
                      ...
                      child: MyButton(
                        title: "reminders_label_deletereminder".tr(),
                        height: 46,
                        titleSize: 14,
                        fontWeight: FontWeight.w600,
                        titleColor: ColorConstant.pinkColor,
