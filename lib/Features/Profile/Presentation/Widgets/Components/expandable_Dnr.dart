...
class _ExpandableDnrViewState extends State<ExpandableDnrView> {
  ...
  void maxColumnP(String title, String content) {
            ...
            Row(
              children: [
                ...
                CustomSwitch(
                  ...
                  value: widget.resuscitateInfo.allow == 1 ? true : false,
                  onChanged: (value) {
                    setState(() {
                      widget.resuscitateInfo.allow = value == true ? 1 : 0;
                      if (!value) {
                        return maxColumnP("editprofil_label_donotrecusitate".tr(),"editprofil_label_donotrecusitatedesc".tr());
                      }
                    });
                  },
                ),
                    ...
                    ? Column(
                        ...
                        children: [
                          ...
                          ListView.builder(
                            ...
                            itemCount: widget.resuscitateInfo.documents.length,
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return new Container(
                                ...
                                child: Row(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    widget.resuscitateInfo.documents[index]
                                                .data !=
                                            null
                                        ? widget.resuscitateInfo
                          ...
                          widget.resuscitateInfo.documents.length == 0
                              ? Row(children: <Widget>[
                                  Expanded(
                                    flex: 12,
                                    child: Align(
