                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Stack(
                      children: [
                        Padding(
                          padding: EdgeInsets.only(top: appBarSize < 100 ? 0 : 0),
                          child: InkWell(
                              child: Container(
                                decoration: BoxDecoration(
                              ...
                              onTap: () {
                                Navigator.of(context).push(PopUpImage(
                                    profile.userGeneralInfo.profilePictureUrl));
                              }),
                        ),
                      ],
                    ...
                    Flexible(
                        child: Column(
                          ...
                          Text(
                           ...
                           profile.medicalRecord.organDonar.donar==1? SvgPicture.asset( 'Assets/Images/donar.svg'
                                              ,color: appBarSize < 100
