...
class _ExpandableListViewState extends State<ExpandableListView> {
    ...
    setState(() {
      ...
      fileName = path != null
          ...
          : paths != null
              ...
              : '...';
      print(fileName);
      widget.profile.parameters.location = widget.type;
  ...
  String convertTime(int time, String mn) {
    if (time > 12) {
      ...
      return time.toString() + mn.toString() + " " + "reminders_label_m".tr();
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        setState(() {
          widget.switchValue
              ? widget.addBlockDiseace[widget.index] =
                  !widget.addBlockDiseace[widget.index]
              : Container();
        });
      },
                    ...
                    ? Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: MyTextField(
                                initialValue: widget.diseace.description,
                                inputType: TextInputType.multiline,
                                editTextBgColor: ColorConstant.textfieldColor,
                                hintTextColor: Colors.white54,
                                title: 'Notes',
                                onChanged: (value) {
                                  widget.diseace.description = value;
                                }),
                          ),
                          SizedBox(
                            height: 22,
                                  ...
                                  itemBuilder:
                                    ...
                                    return new Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          widget.diseace.documents[index]
                                                      .data !=
                                                  null
                                              ? widget.diseace.documents[index]
                                                          .data
                          ...
                          widget.diseace.documents.length == 0
                              ? Row(children: <Widget>[
                                  Expanded(
                                    flex: 12,
                                    child: Align(
                          ...
                          widget.reminders != null
                                            ...
                                            Expanded(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  widget.diseace.reminders[index].reminderDate !=
                                                          null
                                                      ? MyText(
                                                          value: widget
                                                                  .diseace
                              ...
                              : Container(),
                          widget.diseace.reminders.length == 0
                              ? Row(children: <Widget>[
                                  Expanded(
                                    flex: 12,
                                    child: Align(
                                          ...
                                          child: RaisedButton(
                                            ...
                                            onPressed: () async {
                                              await showOverlay(
                                                  ...
                                                  widget.index,
                                                  widget.index,
                                                  widget.diseace.reminders);
                                              setState(() {
                                                nbrReminder = widget
                                                    .diseace.reminders.length;
                                              });
                                            },
                                          )),
                                    ),
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        setState(() {
          widget.switchValue
              ? widget.addBlockBlood[widget.index] =
                  !widget.addBlockBlood[widget.index]
              : Container();
        });
      },
                ...
                ? Column(
                    ...
                    children: [
                      ...
                      widget.diseace.reminder != null
                          ...
                          : Container(),
                      widget.diseace.reminder.length == 0
                          ? Row(children: <Widget>[
                              Expanded(
                                flex: 12,
                                child: Align(
                                  ...
                                  child: ButtonTheme(
                                      ...
                                      child: RaisedButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          setState(() {
                                            nbrReminder =
                                                widget.diseace.reminder.length;
                                          });
                                        },
                                      )),
                                ),
                                      ...
                                      child: ButtonTheme(
                                          ...
                                          child: RaisedButton(
                                              ...
                                              textColor:
                                                  ColorConstant.primaryColor,
                                              child: MyText(
                                                  value: 'editprofil_general_btn_done'.tr(),
                                                  color: ColorConstant
                                                      .primaryColor,
                                                  fontSize: 14,
                                                  fontWeight: FontWeight.w500),
