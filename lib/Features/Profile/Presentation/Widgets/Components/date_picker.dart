...
class _DropdownDatePickerState extends State<DropdownDatePicker> {
        ...
        .map(
          (i) => DropdownMenuItem<int>(
            ...
            child: Container(
              ...
              child: MyText(
                value: Date.toStringWithLeadingZeroIfLengthIsOne(i),
        ...
        .map(
          (i) => DropdownMenuItem<int>(
            ...
            child: Container(
              alignment: Alignment.center,
              child: MyText(
                value: Date.toStringWithLeadingZeroIfLengthIsTwo(i)
                    .substring(0, 3),
              ),
            ),
          ),
  ...
  List<Widget> _buildDropdownButtonsByDateFormat() {
    ...
    switch (widget.dateFormat) {
      case Date_Format.dmy:
        dropdownButtonList
          ..add(MyText(
              value: "editprofil_medical_label_day".tr(),
              fontWeight: FontWeight.w500,
              fontSize: 14,
              color: ColorConstant.textColor))
          ..add(_buildDayDropdownButton())
          ..add(MyText(
              value: "editprofil_medical_label_month".tr(),
              fontWeight: FontWeight.w500,
              fontSize: 14,
              color: ColorConstant.textColor))
  ...
  Widget build(BuildContext context) {
    ...
    widget.profile.userGeneralInfo.birthInfo.month = widget
                ._currentDate.month ==
            null
        ? widget.profile.userGeneralInfo.birthInfo.month
        : Date.toStringWithLeadingZeroIfLengthIsOne(widget._currentDate.month);
    widget.profile.userGeneralInfo.birthInfo.year = widget._currentDate.year;
    return Column(
      children: [
        Row(children: [
          Expanded(
        ...
        Row(
          children: [
            MyText(
                value: "editprofil_medical_label_year".tr(),
                fontWeight: FontWeight.w500,
                fontSize: 14,
                color: ColorConstant.textColor),
            SizedBox(
