...
class _ExpandableListViewState extends State<ExpandableAlsoContactList> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: () {
          setState(() {
            widget.listAddblock[widget.index] =
                !widget.listAddblock[widget.index];
          });
        },
        child: Container(
          ...
          child: Column(
            children: [
              Row(
                children: [
                  Expanded(
                    child: widget.listAddblock[widget.index]
                        ? Center(
                            child: Row(children: <Widget>[
                              Expanded(
                                ...
                                child: MyTextField(
                                  ...
                                  title: "registration_input_firstname".tr(),
                              ...
                              Expanded(
                                ...
                                child: MyTextField(
                                  ...
                                  maxline: 1,
                                  title: "registration_input_lastname".tr(),
                                  inputType: TextInputType.number,
                                  editTextBgColor: ColorConstant.textfieldColor,
                                  hintTextColor: Colors.white54,
                                  onChanged: (value) {
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            (widget.userEmergencyContact.mail == null ||
                                        widget.userEmergencyContact.mail ==
                                            '') &&
                                    (widget.userEmergencyContact.mail2 == '' ||
                                        widget.userEmergencyContact.mail2 ==
