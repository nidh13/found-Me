...
/* 
                            ...
                            return widget.idMembers ==
                                ...
                                ? Container(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      onTap: () {
                                        print(widget.children[index].tagInfo
                                            .tagDescription);

                                        print(widget.children[index]);

                                        dispatchViewTag(profile, widget.type,
                                            widget.indexu, index);
                                      },
                                    ),
                                  )
  ...
  void dispatchViewTag(Profile profile, String type, int indexu, int index) {
    BlocProvider.of<TagsBloc>(context).dispatch(
