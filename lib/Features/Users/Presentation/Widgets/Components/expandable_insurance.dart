  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        onTap: () {
          setState(() {
            active
                ? widget.addBlockInsurrance[widget.index] =
                    !widget.addBlockInsurrance[widget.index]
                : Container();
          });
          print(widget.addBlockInsurrance);
        },
        child: Container(
          ...
          child: Column(
            children: [
              Row(
                children: [
                  Expanded(
                      child: widget.addBlockInsurrance[widget.index]
                          ? Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  widget
                                                          ...
                                                          null
                                                      ? MyText(
                                                          value: widget.insuranceInfo.reminders[index].reminderDate.substring(8, 12) +
                                                              " " +
                                                              widget.insuranceInfo.reminders[index].reminderDate
                                                                  .substring(
                                                                      5, 7) +
                                                              " " +
                                                              widget
