...
import 'package:neopolis/Features/Users/Presentation/Widgets/Components/alert_reminder.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        setState(() {
          widget.switchValue
              ? widget.addBockDiseace[widget.index] =
                  !widget.addBockDiseace[widget.index]
              : Container();
        });
      },
                              ...
                              ? MyButton(
                                  ...
                                  onPressed: nbrReminder < nbReminderFixe
                                      ? () async {
                                          ...
                                          setState(() {
                                            nbrReminder =
                                                widget.diseace.reminders.length;
                                          });
                                        }
                                      : null,
                                )
