      ...
      child: Center(
        child: Container(
          decoration: BoxDecoration(
            border: Border(
              top: BorderSide(width:widget.borderSize??0.0, color:widget.borderColor?? resolvedBorderColor),
              bottom: BorderSide(width:widget.borderSize??0.0, color:widget.borderColor?? resolvedBorderColor),
            ),
          ),
