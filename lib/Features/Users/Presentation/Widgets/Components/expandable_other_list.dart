...
class ExpandableOtherList extends StatefulWidget {
  final OtherMedicalRecordInfo other;
...
class _ExpandableListViewState extends State<ExpandableOtherList> {
  PopupMenu menu;
    ...
    setState(() {
      ...
      fileName = path != null
          ...
          : paths != null
              ...
              : '...';
      print(fileName);
      widget.profile.parameters.location = 'otherMedicalRecordInfo';
      widget.profile.parameters.locationIndex = widget.index;
      widget.profile.parameters.file = docFile;

      dispatchUploadFile(widget.profile, widget.index);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        setState(() {
          widget.switchValue
              ? widget.addBlockOther[widget.index] =
                  !widget.addBlockOther[widget.index]
              : Container();
        });
      },
                ...
                widget.visibilite == true
                    ? CustomSwitch(
                        ...
                        onChanged: (value) {
                          print("VALUE : $value");
                          setState(() {
                            widget.other.allow = value == true ? 1 : 0;
            ...
            widget.addBlockOther[widget.index]
                ? Column(
                    ...
                    children: [
                      ...
                      widget.other.reminder != null
                          ? ListView.builder(
                              shrinkWrap: true,
                              physics: NeverScrollableScrollPhysics(),
                              itemCount: widget.other.reminder.length,
                              padding: EdgeInsets.zero,
                              itemBuilder: (BuildContext context, int index) {
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                widget.other.reminder[index].reminderDate !=
                                                        null
                                                    ? MyText(
                                                        value: widget
                                                                .other
                          ...
                          : Container(),
                      widget.other.reminder.length == 0
                          ? Row(children: <Widget>[
                              Expanded(
                                flex: 12,
                                child: Align(
